...
Основные константы хранятся в "Golden image" в папке установки. Любой параметр может быть перезаписан в конфигурационном файле `config.yaml` в папке `/etc/ddg-idd-driver/` или в папке `~/ddg-idd-driver/` 
